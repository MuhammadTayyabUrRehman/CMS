      ...
      <div className="space-y-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-muted">
              Activity timeline for a single complaint, including dispatches.
            </p>
          </div>
          <Link
            href="/staff/queue"
        ...
        >
          ...
          <input
            ...
            type="text"
            placeholder="Paste a complaint ID (from the queue, e.g. a UUID)"
            value={manualId}
        ...
        {!loading && !complaintId && !history.length && !error && (
          <div className="rounded-xl border border-gray-200 bg-white p-10 text-center shadow-sm">
            <p className="text-base font-semibold text-foreground">
              Select a complaint to view its assignment history.
            </p>
            <p className="mt-2 text-sm text-muted">
              Use the input above with a complaint ID from the dispatch queue, or click
              &quot;View History&quot; on a queue row.
            </p>
          </div>
        )}
